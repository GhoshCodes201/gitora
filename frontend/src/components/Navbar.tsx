    ...
    <header className="sticky top-0 z-20 border-b border-border bg-bg/80 backdrop-blur">
      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        <Link to="/" className="group flex items-center gap-2.5">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-accent to-cyan font-display text-lg font-bold text-white shadow-[0_0_20px_-4px_rgba(139,92,246,0.7)] transition group-hover:shadow-[0_0_28px_-4px_rgba(139,92,246,0.9)]">
            G
          </span>
